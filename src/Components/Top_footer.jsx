...
function Top_footer() {
    return (
        <>
            ...
            <Flex h='20px' w='100%'></Flex>
            
            {/* Main heading for the footer */}
            <Heading as='h6' p='0% 3%' size='md'>
            ...
            {/* Description text about Tata 1mg */}
            <Text p='0% 3%'>
                Tata 1mg is India's leading digital healthcare platform. From doctor consultations 
                on chat to online pharmacy and lab tests at home: we have it all covered for you. 
                Having delivered over 25 million orders in 1000+ cities till date, we are on a 
                mission to bring "care" to "health" to give you a flawless healthcare experience.
            </Text>
            
            {/* Another heading for emphasis */}
            <Heading as='h6' p='0% 3%' size='md' mt='5px'>
                Tata 1mg: Your Favourite Online Pharmacy!
            </Heading>
            
            <br />
            
            {/* Detailed text about the services and ease of using Tata 1mg */}
            <Text p='0% 3%'>
            ...
            {/* Heading highlighting achievements */}
            <Heading as='h6' p='0% 3%' size='md' mt='5px'>
            ...
            {/* Text about the awards and recognitions Tata 1mg has received */}
            <Text p='0% 3%'>
                At Tata 1mg, our goal is to make healthcare understandable, accessible and affordable in India.
                We set out on our journey in 2015, and have come a long way since then. Along the way, we have
                been conferred with prestigious titles like BML Munjal Award for 'Business Excellence through
                Learning and Development', Best Online Pharmacy in India Award and Top 50 venture in The Smart
                CEO-Startup50 India. We have been selected as the only company from across the globe for SD#3
                "Health & Well Being for all" by Unreasonable group, US State Department. In 2019 alone we
                received three awards including the BMW Simply Unstoppable Award.
            </Text>
            
            {/* Heading for listing services offered */}
            <Heading as='h6' p='0% 3%' size='md' mt='5px'>
            ...
            {/* Text describing the range of services offered by Tata 1mg */}
            <Text p='0% 3%'>
                ...
                Visit our online medical store now, and avail online medicine purchase at a discount.<br />
                Stay Healthy!
            </Text>
        </>
    );
