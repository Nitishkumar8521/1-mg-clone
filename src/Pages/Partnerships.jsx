...
function Partnerships(){
    ...
    <HStack gap={10} justify='center'>
        <VStack align='start'>
            <Text fontSize='3xl' as='b'>Transforming Workplace <br /> Wellness </Text>
            <Text>Empower your employees with our holistic corporate <br /> 
            health & wellness programs. Experience customized <br /> 
            health checkups, employee wellness initiatives, and <br />
             seamless medicine delivery services.</Text>
    ...
    <HStack pt='30px' bg='gray.50' justify='center' gap={10}>
        <Box pb='350px'>
            ...
            <Text>Boost your company's health initiatives with Tata 1mg's tailored corporate <br /> wellness services across India</Text>
            <HStack pt='10px'><i class="fa-solid fa-envelope"></i> <Text>Email:</Text><Text color='red.400'>sales@1mg.com</Text></HStack>
        </Box>
        <Box boxShadow='md' w='40%' bg='white' p='20px 20px'> 
          ...
          <FormControl isRequired>
               <FormLabel>Services you would like to knwo about</FormLabel>
               <Select>
